...
function Collection() {
    ...
    const [subCategory,setsubCaegory]=useState([]);
    ...
    const applyFilter=()=>{
        ...
        if(category.length>0){productsCopy=productsCopy.filter(items=>category.includes(item.category));}
        if(subCategory.length>0){productsCopy=productsCopy.filter(items=>subCategory.includes(item.subCategory));}
